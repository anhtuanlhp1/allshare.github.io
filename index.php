...
<head>
    ...
    <!-- Page title -->
    <title>Hoàng Đức Anh Tuấn - FPT UNIVERSITY</title>
        ...
        <div class="container-fluid">
            ...
            <div id="navbar" class="navbar-collapse collapse">
                ...
                <form class="navbar-form navbar-left">
                    <input type="text" class="form-control" placeholder="Bot Cảm Xúc - Tunz" style="width: 175px">
                </form>
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown">
                        <a href="https://www.facebook.com/anhtuanlhp1" >Versions
                            <span class="label label-warning pull-right">Cookie</span>
                        </a>
                    </li>
                    <li class=" profil-link">
                        <a href="login.html">
                            <span class="profile-address">Susano</span>
                            <img src="https://scontent.fhan2-2.fna.fbcdn.net/v/t1.0-9/18813918_1797716330544741_7525755144838203995_n.jpg?oh=81547f9bcfad66461bf04fb10e93f7e5&oe=59D6069F" class="img-circle" alt="">
                        </a>
                    </li>
                </ul>
            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="view-header">
                            <div class="pull-right text-right" style="line-height: 14px">
                                <small>Tunz<br>Dashboard<br> <span class="c-white">v.3.0</span></small>
                            </div>
                            <div class="header-icon">
                                <i class="pe page-header-icon pe-7s-shield"></i>
                            </div>
                            <div class="header-title">
                                <h3 class="m-b-xs">Tunz</h3>
                                <small>
...
<?php if(!$_SESSION[id])
{
    ?>
                    ...
                    <div class="panel panel-filled">
						...
						<p> Nếu Bạn Sử Dụng <code> Tunz</code> Trên Điện Thoại Và Không Lấy Được Cookie  ? <p>
